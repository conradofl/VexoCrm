...
// NOTA: SuggestionsTab não é renderizado em nenhuma aba do FollowupDashboard atual (só journeys/metrics/config).
...
import { SUGGESTIONS_TAB_LABELS } from "@/lib/followup/constants";
...
export function SuggestionsTab({ companyId }: { companyId: string }) {
