...
// NOTA: FilaTab não é renderizado em nenhuma aba do FollowupDashboard atual (só journeys/metrics/config).
...
import { useFupCampaigns, useFupTemplates } from "@/hooks/useFollowupAdmin";
import {
  useFollowupQueue,
...
import { formatDate } from "@/lib/followup/helpers";
import { QUEUE_STATUS_LABELS, QUEUE_STATUS_COLORS } from "@/lib/followup/constants";
...
export function FilaTab({ companyId }: { companyId: string }) {
