  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 p-8">
      ...
      <div className="text-center">
        <p className="text-base font-semibold text-foreground">Aquecimento de Chip</p>
        <p className="mt-1 max-w-xs text-sm text-muted-foreground">
          Programe o aquecimento automático de instâncias para reduzir risco de ban. Em construção.
        </p>
      </div>
    </div>
  );
