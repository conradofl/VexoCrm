...
export const AI_PROCESSING_STEPS: { t: string; fId: string | null }[] = [
      ...
      // Os dois ids abaixo estavam errados ("atuacao" e "publico"), nomes que não
      // existem em DEFAULT_BRIEFING_FIELDS. Como o preenchimento casa por id,
      // Localização e Público Alvo nunca eram preenchidos pela transcrição.
      ...
      { t: "Procurando base de clientes para remarketing...", fId: "base_existente" },
      { t: "Identificando os produtos foco das campanhas...", fId: "produtos_trafego" },
      { t: "Definindo o objetivo por etapa do funil...", fId: "objetivo_trafego" },
      { t: "Calculando a verba disponível...", fId: "verba" },
      { t: "Confirmando a periodicidade do investimento...", fId: "verba_periodicidade" },
      { t: "Dividindo o investimento entre Google e Meta...", fId: "divisao_verba" },
      { t: "Mapeando sazonalidade e datas que puxam demanda...", fId: "sazonalidade" },
